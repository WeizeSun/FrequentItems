...
public class DoubleItemsSONPhase2{
            ...
            for(String line: lineArr){
                ...
                for(String wordOne: words){
                    for(String wordTwo: words){
                        if(wordOne.compareTo(wordTwo) < 0 && candidates.contains(wordOne+","+wordTwo)){
                            context.write(new Text(wordOne+","+wordTwo), new IntWritable(1));
                        }
                    }
                }
            }
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setJarByClass(DoubleItemsSONPhase2.class);
