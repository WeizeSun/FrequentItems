...
public class TripleItemsSONPhase1{
	...
	public static class Map extends Mapper<LongWritable, Text, Text, IntWritable>{
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
			...
			Hashtable<String, Integer>tripletons = new Hashtable<String, Integer>();
				...
				for(String keyOne: candidates){
					for(String keyTwo: candidates){
						for(String keyThree: candidates){
							if(keyOne.compareTo(keyTwo) < 0 && keyOne.compareTo(keyThree) < 0 && keyTwo.compareTo(keyThree) < 0 && doubletons.containsKey(keyOne+","+keyTwo) && doubletons.containsKey(keyOne+","+keyThree) && doubletons.containsKey(keyTwo+","+keyThree)){
								if(tripletons.containsKey(keyOne+","+keyTwo+","+keyThree)){
									tripletons.put(keyOne+","+keyTwo+","+keyThree, tripletons.get(keyOne+","+keyTwo+","+keyThree) + 1);
								}
								else{
			...
			for(Iterator<Entry<String, Integer>>it = tripletons.entrySet().iterator(); it.hasNext(); ){
				Entry<String, Integer>temp = it.next();
				if((double)temp.getValue() / lcount < s){
					it.remove();
				}
	...
	public static void main(String[] args) throws Exception{
		...
		job.setJarByClass(TripleItemsSONPhase1.class);
